...
Scaffold a new tool called `$ARGUMENTS` for the RustyTalon agent. First, determine the tool type and then follow the appropriate path.
...
version = "0.1.0"
edition = "2021"
description = "<Description> tool for RustyTalon (WASM component)"
