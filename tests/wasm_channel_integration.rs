...
use rustytalon::channels::Channel;
use rustytalon::channels::wasm::{
...
use rustytalon::pairing::PairingStore;
...
mod loader_tests {
    ...
    async fn test_discover_channels_empty_dir() {
        ...
        let channels = rustytalon::channels::wasm::discover_channels(dir.path())
            .await
...
mod message_emission_tests {
    use super::*;
    use rustytalon::channels::wasm::{ChannelHostState, EmittedMessage};
