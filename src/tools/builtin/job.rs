...
///
/// Auto-creates `~/.rustytalon/projects/{project_id}/` so every sandbox job has a
...
/// it is validated to fall within `~/.rustytalon/projects/` after canonicalization.
            ...
            serde_json::json!({
                ...
                "properties": {
                    ...
                    "mode": {
                        ...
                        "description": "Execution mode. 'worker' (default) uses the RustyTalon sub-agent. \
